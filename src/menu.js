//#region - Menu Items
const coffeeItem = `<h3>Coffee - $2.00 / $3.00 / $4.00</h3><br>Savor the bold essence of our premium coffee blend—a symphony of rich flavors meticulously brewed for your enjoyment.`;
...
const cappItem = `<h3>Cappuccino - $3.50 / $4.50 / $5.00</h3><br>Indulge in the velvety richness of our cappuccino. Perfectly layered espresso, steamed milk, and a luxurious foam create a blissful coffee experience.`;
const cappSrc = './img/cappuccinoImg.jpg';
const cappAlt = 'cappuccinoImg';

const macchiatoItem = `<h3>Macchiato - $3.00 / $3.50 / $4.00</h3><br>Indulge in our Macchiato. Espresso shots subtly adorned with velvety steamed milk, creating a harmonious blend of boldness and creaminess.`;
const macchiatoSrc = './img/macchiatoImg.jpg';
const macchiatoAlt = 'macchiatoImg';

const americanoItem = `<h3>Americano - $2.50 / $3.00 / $3.50</h3><br>Experience the simplicity of our Americano. Smooth espresso shots blended with hot water, creating a bold and invigorating coffee sensation.`;
const americanoSrc = './img/americanoImg.jpg';
const americanoAlt = 'americanoImg';

const cocoaItem = `<h3>Hot Cocoa - $2.50 / $3.00 / $3.50</h3><br>Embrace warmth with our decadent hot cocoa. Rich chocolate, steamed milk, and a cloud of whipped cream create a cozy indulgence.`;
